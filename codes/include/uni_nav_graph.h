...
namespace ANNS
{
    ...
    public:
        ...
        void search(std::shared_ptr<IStorage> query_storage, std::shared_ptr<IStorage> query_storage_o, std::shared_ptr<DistanceHandler> distance_handler,
    ...
    private:
        ...
        IdxType cost_iterate_to_fixed_point(const char *query, std::shared_ptr<SearchCache> search_cache,
                                            IdxType target_id, const std::vector<IdxType> &entry_points,
                                            // std::vector<std::unordered_map<ANNS::IdxType, float>> &all_cost_entries,
                                            float alpha,
